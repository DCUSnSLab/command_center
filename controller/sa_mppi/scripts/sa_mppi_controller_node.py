...
from sa_mppi_controller.utils.sensor_processor import SensorProcessor
...
class SMPPIControllerNode(Node):
    ...
    def __init__(self):
        super().__init__('sa_mppi_controller')
    ...
    def _setup_topics(self):
        ...
        if self.enable_visualization:
            ...
            self.marker_pub = self.create_publisher(
                MarkerArray, '/sa_mppi_visualization', reliable_qos)
    ...
    def create_obstacle_markers(self) -> list:
        ...
        if len(self.obstacles.obstacle_points) > 0:
            ...
            safety_marker.ns = "sa_mppi_safety_zones"
            safety_marker.id = 11
