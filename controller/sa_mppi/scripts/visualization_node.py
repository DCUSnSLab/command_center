...
from sa_mppi.msg import ProcessedObstacles, OptimalPath, MPPIState
...
from sa_mppi_controller.utils.geometry import GeometryUtils
...
class VisualizationNode(Node):
    ...
    def __init__(self):
        super().__init__('sa_mppi_visualization')
    ...
    def _declare_parameters(self):
        ...
        self.declare_parameter('topics.output.markers', '/sa_mppi_visualization')
    ...
    def _setup_topics(self):
        ...
        self.lookahead_sub = self.create_subscription(
            PoseStamped, '/sa_mppi_visualization/lookahead_point', self.lookahead_callback, reliable_qos)
        self.target_direction_sub = self.create_subscription(
            PointStamped, '/sa_mppi_visualization/target_direction', self.target_direction_callback, reliable_qos)
    ...
    def create_trajectory_marker(self) -> Optional[Marker]:
        ...
        traj_marker.ns = "sa_mppi_trajectory"
        traj_marker.id = 1
    ...
    def create_obstacle_markers(self) -> list:
        ...
        obstacle_marker.ns = "sa_mppi_obstacles"
